...
unzip(tf, exdir = 'data/2016-01-02-big-year/', overwrite = TRUE)
unlink(tf)
download.file(paste0(base_url, 'physical/ne_110m_graticules_all.zip'), tf)
unzip(tf, exdir = 'data/2016-01-02-big-year/', overwrite = TRUE)
unlink(tf)

world_wgs <- shapefile('data/2016-01-02-big-year/ne_110m_admin_0_countries.shp')
bbox_wgs <- shapefile('data/2016-01-02-big-year/ne_110m_wgs84_bounding_box.shp')
grat_wgs <- shapefile('data/2016-01-02-big-year/ne_110m_graticules_20.shp')
```
