...
|X1                                                                                                                   |X2                        |X3    |X4    |X5               |
|:--------------------------------------------------------------------------------------------------------------------|:-------------------------|:-----|:-----|:----------------|
|Here is a complete list of the birds Noah identified on his 2015 Big Year adventure, in reverse chronological order. |NA                        |NA    |NA    |NA               |
|Day 365: So Long, and Thanks For All The Birds                                                                       |NA                        |NA    |NA    |NA               |
...
|X1                                          |X2                       |X3   |X4      |X5            |
|:-------------------------------------------|:------------------------|:----|:-------|:-------------|
|4567                                        |White-throated Babbler   |10/2 |Myanmar |Bagan Temples |
|4566                                        |Vinous-breasted Starling |10/2 |Myanmar |Bagan Temples |
|4565                                        |Richard's Pipit          |10/2 |Myanmar |Bagan Temples |
|4564                                        |Plain-backed Sparrow     |10/2 |Myanmar |Bagan Temples |
|Day 274: Zero Bird Day No. 3                |NA                       |NA   |NA      |NA            |
|For previous three months, please see here. |NA                       |NA   |NA      |NA            |
...
| species_num|species         |date       |country    |site               | day|
|-----------:|:---------------|:----------|:----------|:------------------|---:|
|           6|Antarctic Shag  |2015-01-01 |Antarctica |Mikkelsen Harbor   |   1|
|           5|Brown Skua      |2015-01-01 |Antarctica |Mikkelsen Harbor   |   1|
|           4|Kelp Gull       |2015-01-01 |Antarctica |Mikkelsen Harbor   |   1|
|           3|Antarctic Tern  |2015-01-01 |Antarctica |Mikkelsen Harbor   |   1|
|           2|Southern Fulmar |2015-01-01 |Antarctica |Off Trinity Island |   1|
|           1|Cape Petrel     |2015-01-01 |Antarctica |Off Trinity Island |   1|
...
Noah visited 54 countries (counting the Falklands as a distinct country) over 365 days and saw an average of 111.89 new species per country and 16.55 new species per day. Let's dive into this a little more with some plots.
...
<img src="/figures//2016-01-02-big-year_trend-1.svg" title="Trend in species seen over the course of the big year." alt="Trend in species seen over the course of the big year." style="display: block; margin: auto;" />
...
<img src="/figures//2016-01-02-big-year_by-month-1.svg" title="Number of new bird species in each month." alt="Number of new bird species in each month." style="display: block; margin: auto;" />
...
<img src="/figures//2016-01-02-big-year_by-day-1.svg" title="plot of chunk by-day" alt="plot of chunk by-day" style="display: block; margin: auto;" />
...
```
## Error: cannot join on columns 'country_code' x 'country_code': index out of bounds
```
...
```
## Error: unknown column 'continent_name'
```
...
<img src="/figures//2016-01-02-big-year_by-continent-1.svg" title="plot of chunk by-continent" alt="plot of chunk by-continent" style="display: block; margin: auto;" />
...
<img src="/figures//2016-01-02-big-year_by-country-1.svg" title="plot of chunk by-country" alt="plot of chunk by-country" style="display: block; margin: auto;" />
...
<img src="/figures//2016-01-02-big-year_trend-cont-1.svg" title="plot of chunk trend-cont" alt="plot of chunk trend-cont" style="display: block; margin: auto;" />
...
<img src="/figures//2016-01-02-big-year_map-1.svg" title="plot of chunk map" alt="plot of chunk map" style="display: block; margin: auto;" />
...
<img src="/figures//2016-01-02-big-year_map-by-day-1.svg" title="plot of chunk map-by-day" alt="plot of chunk map-by-day" style="display: block; margin: auto;" />
