...
Having looked at the data, I know there are a handful of problems in the species names. Some are typos and some are inconsistencies with the species names on eBird. Although, it should affect the analysis, I'd prefer a clean dataset, so I'll manually fix them here.
