...
So, with a million points, I get an error of `r round(100 * subset(estimate_summary, n_pts == 1e6)$error_mean, 4)`%; however, there is clearly an effect of diminishing returns: execution time increases linearly with number of points, but gains in precision are decreasing exponentially.  
