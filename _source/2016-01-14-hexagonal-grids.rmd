...
```{r setup, echo = F}
opts_chunk$set(cache.path = "cache/hexagonal-grids/")
```
...
```{r nice-grid, cache=T, echo=-1, fig.width=600/96, fig.height=600/96}
...
```{r raster, echo=-1, dev = 'png', fig.width=250/96, fig.height=350/96}
...
```{r square-polys, cache=T, echo=-1, fig.width=600/96, fig.height=600/96}
par(mar = c(0.25, 0.25, 0.25, 0.25), mfrow = c(2, 2))
...
```{r point-density, dev = 'png', fig.retina = 2, fig.width=600/96, fig.height=600/96}
...
```{r cover-plots, dev = 'png', fig.retina = 2, fig.width=600/96, fig.height=400/96}
# area
...
```{r extract, dev = 'png', fig.retina = 2, fig.width=600/96, fig.height=350/96}
